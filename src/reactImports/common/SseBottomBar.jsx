            ...
            <div className={this.props.className}
                ...
                <div className="hflex">
                    <div className="grow hflex flex-align-items-center children-margin">
                        ...
                        <button className="sse-button">{i18n.gettext("Tags")}</button>
                        {this.props.allTags.map(t => (<div key={t} className="sse-tag">{t}</div>))}
                    </div>
                    <SseText msgKey="bottom-right-label"/>
                </div>
                <Dialog open={this.state.open}>
                    <DialogTitle>{i18n.gettext("Tags")}</DialogTitle>
                    <DialogContent>
                        <div className="vflex">
