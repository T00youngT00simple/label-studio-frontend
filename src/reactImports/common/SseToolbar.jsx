...
export default class SseToolbar extends React.Component {
    ...
    addCommand(name, title, isToggle, shortcut, actionMessage, icon, initialState, legend, desc) {
        const command = {name, title, isToggle, shortcut, actionMessage, icon, legend, desc};
