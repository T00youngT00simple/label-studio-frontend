...
export default class SseCameraToolbar extends SseToolbar {
    ...
    componentDidMount() {
        ...
        this.addCommand("viewCameraCommand", i18n.gettext("Camera View"), false, "C", "view-camera", Video, undefined, undefined);
        this.addCommand("viewFrontCommand", i18n.gettext("Front View"), false, "F", "view-front", ArrowCollapseUp, undefined, undefined);
        this.addCommand("viewBehindCommand", i18n.gettext("Behind View"), false, "B", "view-behind", ArrowCollapseDown, undefined, undefined);
        this.addCommand("viewTopCommand", i18n.gettext("Top View"), false, "T", "view-top", ArrowExpandDown, undefined, undefined);
        this.addCommand("viewLeftCommand", i18n.gettext("Left View"), false, "L", "view-left", ArrowCollapseLeft, undefined, undefined);
        this.addCommand("viewRightCommand", i18n.gettext("Right View"), false, "R", "view-right", ArrowCollapseRight, undefined, undefined);
        this.addCommand("viewCenterCommand", i18n.gettext("Center View"), false, "X", "view-center", Target, undefined, undefined);
        this.addCommand("hullCommand", i18n.gettext("Show Hull"), false, "H", "show-hull", CubeSend, undefined, undefined);
        this.addCommand("orientationCommand", i18n.gettext("Pointcloud Orientation"), false, "-", "orientation-change", Rotate3D, undefined, " ");
        this.addCommand("colorBoostCommand", i18n.gettext("Color Intensity"), 1, "-", "color-boost-toggle", Brightness6, undefined, " ");
        this.addCommand("pointSizeCommand", i18n.gettext("Point Size"), 1, "-", "point-size-toggle", ImageFilterTiltShift, undefined, " ");
        this.addCommand("distanceAttenuationCommand", i18n.gettext("Distance Attenuation"), Blur, "", "distance-attenuation", BlurOff, undefined, undefined);
        this.addCommand("rgbCommand", i18n.gettext("Toggle RGB"), LightbulbOn, "+", "rgb-toggle", Lightbulb, undefined, undefined);
