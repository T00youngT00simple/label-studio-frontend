        ...
        return (<div className={"object-button" + (this.state.selected ? " selected" : "")}>
            <button onClick={() => this.onClick()}>
                <div className="hflex flex-align-items-center">
                    ...
                    <span>{label}</span>
                    {this.props.object.sequence &&
                        <span>-{this.props.object.sequence}</span>
                    } 
                </div>
            </button>
        </div>);
...
export default class SseObjectToolbar extends SseToolbar {
    ...
    componentDidMount() {
        ...
        this.addCommand("newObjectCommand", i18n.gettext("New Object"), false, "Create new object", "object-new", Plus, undefined, i18n.gettext("Create Object"));
        this.addCommand("deleteObjectCommand", i18n.gettext("Delete Object"), false, ",", "object-delete", Delete, undefined, i18n.gettext("Delete Object"));
        this.addCommand("addPointsObjectCommand", i18n.gettext("Add Points"), false, "", "object-add-points", PlusCircleOutline, "undefined", i18n.gettext("Add Points"));
        this.addCommand("removePointsObjectCommand", i18n.gettext("Remove Points"), false, "", "object-remove-points", MinusCircleOutline, "undefined", i18n.gettext("Remove Points"));
        this.addCommand("unselectObjectCommand", i18n.gettext("Unselect Object"), false, "", "object-unselect", Close, undefined, undefined);
        this.addCommand("focusObjectCommand", i18n.gettext("Focus Object"), false, "", "object-focus", Target, undefined, i18n.gettext("Focus Object"));
        ...
        return (
            <div className="hflex h100 flex-justify-content-center flex-align-items-center">
                {this.state.newButtonVisible ?
                    ...
                    <div>{i18n.gettext("No Selected Object")}</div>
                }
            </div>);
    }
